...
public class FragmentCheckoutBindingImpl extends FragmentCheckoutBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    protected void executeBindings() {
        ...
        java.lang.String orderViewModelAccompanimentNameToString = null;
        ...
        if ((dirtyFlags & 0x1bfL) != 0) {
            ...
            if ((dirtyFlags & 0x1a0L) != 0) {
                    ...
                    if (orderViewModelAccompanimentName != null) {
                        // read OrderViewModel.accompaniment.getValue().name.toString()
                        orderViewModelAccompanimentNameToString = orderViewModelAccompanimentName.toString();
                    }
            }
        }
        // batch finished
        if ((dirtyFlags & 0x1a0L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.accompanimentSelection, orderViewModelAccompanimentNameToString);
        }
